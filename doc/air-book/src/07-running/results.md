...
More detailed information can be found in [Interpreting AIR Results](./interpreting-results.md) and [Interpretation States](./interpreting-states.md) provides a summary of all possible result states.
