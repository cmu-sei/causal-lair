...
-   Ribbon Plot Colors
    ...
    -   [Dark Gray]{style="color: #9394A2; font-weight: bold;"}: The dot (causal estimate) and lines (95% confidence interval) drawn in this color correspond to the first identified adjustment set in your data. 
    -   [Light Gray]{style="color: #D4C7C7; font-weight: bold;"}: The dot (causal estimate) and lines (95% confidence interval) drawn in this color correspond to the second identified adjustment set in your data. 
