...
output$live_log_tail <- renderUI({
  # retrieve the active logfile from the global environment
  logfile <- tryCatch({
  ...
  msg <- gsub("ERROR", "<b style='color:red'>ERROR</b>", msg)
  msg <- gsub("WARN",  "<b style='color:orange'>WARN</b>", msg)
  msg <- gsub("INFO",  "<b style='color:green'>INFO</b>", msg)

  # Display as preformatted HTML
  HTML(paste0(
    "<div style='font-family:monospace; font-size:0.9em; background-color:#ddd; color:#111; ",
    "padding:10px; border-radius:6px; height:400px; overflow-y:auto;'>",
    "<strong>Live log:</strong><br><br>",
    "<pre style='white-space:pre-wrap;'>", msg, "</pre></div>"
  ))
})
### file input text --------------------------------------
