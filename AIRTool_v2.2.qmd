...
output$download_report <- downloadHandler(
  ...
  content = function(file) {
    ...
    loc_final_graph <- get_final_graph(AIRHome, loc_xvar, loc_yvar, Zvars)
    ...
    # df = loc_df,
    # tv_dir = loc_tv_dir,
    # tv_threshold = loc_tv_threshold,
    # ov_dir = loc_ov_dir,
    # ov_threshold = loc_ov_threshold,
    # df_vars = loc_df_vars,
    # Zvars = loc_Zvars,
    # graph_update = loc_graph_update
    quarto::quarto_render(
      input = "scripts/AIRReport.qmd",
      output_format = "pdf",
      execute_params = list(AIRHome = AIRHome,
                            xvar = loc_xvar,
                            yvar = loc_yvar,
    ...
    generated_file_name <- paste0('AIRTool-Report_', Sys.Date(), '.pdf')
