...
observeEvent(input$goButton, {
    ...
    combos <- expand.grid(i = unique(Zvars$name), j = unique(Zvars$grp)) 
    ...
    foreach(k = 1:nrow(combos), 
            ...
            .export = c("Zvars", "runSuperLearner", "AIRHome", "tv_dir_val", "tv_threshold_val", "ov_dir_val", "ov_threshold_val", "df_vars")) %dopar% {
        i <- combos[k, "i"]
        j <- combos[k, "j"]
        ...
        tryCatch({
          ...
          errMsg <- sprintf("Error in combination i=%s, j=%s: %s", i, j, conditionMessage(e))
